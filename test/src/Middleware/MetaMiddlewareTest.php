...
use FactorioItemBrowser\ExportQueue\Server\Middleware\MetaMiddleware;
 ...
 * @coversDefaultClass \FactorioItemBrowser\ExportQueue\Server\Middleware\MetaMiddleware
 */
