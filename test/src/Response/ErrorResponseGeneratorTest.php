...
use FactorioItemBrowser\ExportQueue\Server\Response\ErrorResponseGenerator;
 ...
 * @coversDefaultClass \FactorioItemBrowser\ExportQueue\Server\Response\ErrorResponseGenerator
 */
class ErrorResponseGeneratorTest extends TestCase
{
    ...
    {
        $exception = new ExportQueueServerException('foo', 123);
